...
@section('content')
    ...
    <style>
        ...
        .table th,
        .table td {
            padding-top: 15px; /* Espaçamento superior do conteúdo da célula */
            padding-bottom: 15px; /* Espaçamento inferior do conteúdo da célula */
            border-bottom: 1px solid #dee2e6; /* Adiciona uma linha separadora entre as linhas */
        }
    </style>
